...
<div class="page">
    ...
    <main class="content  container">
        ...
        <h1 class="page__title">Pages list</h1>

        <div class="row">
            <div class="col-xs-12">
                <ul class="list">
                    <li class="list__item"><a href="add_ads.html">Add new ads</a></li>
                    <li class="list__item"><a href="ads_inner.html">Ads inner page</a></li>
                    <li class="list__item"><a href="ads_list.html">Ads list</a></li>
                    <li class="list__item"><a href="balance.html">Account balance</a></li>
                    <li class="list__item"><a href="banner_list.html">User banner list</a></li>
                    <li class="list__item"><a href="banner.html">User create banner</a></li>
                    <li class="list__item"><a href="cat_inner.html">Categories</a></li>
                    <li class="list__item"><a href="checkout.html">Checkout</a></li>
                    <li class="list__item"><a href="contacts.html">Contacts</a></li>
                    <li class="list__item"><a href="faq.html">FAQ</a></li>
                    <li class="list__item"><a href="index.html">Home page</a></li>
                    <li class="list__item"><a href="login.html">Login page</a></li>
                    <li class="list__item"><a href="ads_list.html">User ads list</a></li>
                    <li class="list__item"><a href="profile.html">Profile page</a></li>
                    <li class="list__item"><a href="recover.html">Recover password</a></li>
                    <li class="list__item"><a href="rules.html">Rules</a></li>
                    <li class="list__item"><a href="search.html">Search</a></li>
                    <li class="list__item"><a href="signup.html">Signup</a></li>
                    <li class="list__item"><a href="subcat.html">Subcategories</a></li>
                    <li class="list__item"><a href="ui.html">UI</a></li>
                </ul>
            </div>
        </div><!-- /.row -->
